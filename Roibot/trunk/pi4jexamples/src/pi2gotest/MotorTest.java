...
//        
//        for (int i = 0; i < 100; i++) {
//        	rearLED.pulse(25,true);
//        	frontLED.pulse(25,true);
////            Thread.sleep(50);
//		}
//
//        for (int i = 0; i < 10; i++) {
...
//        
//        frontLED.low();
//        System.out.println("--> frontLED state should be: ON");
//        Thread.sleep(5000);
//        frontLED.high();
//        System.out.println("--> frontLED state should be: OFF");
//        rearLED.low();
//        System.out.println("--> rearLED state should be: ON");
//        Thread.sleep(5000);
//        rearLED.high();
//        System.out.println("--> rearLED state should be: OFF");
//        
//        
    ...
    public static void test() throws InterruptedException{
        ...
        for (int j = 0; j < 3; j++) {
    		...
    		for (int i = 0; i <= 100; i++) {
    			pi2go.go(i);
//    	        System.out.println("--> should drive forward: " + i);
    			Thread.sleep(5);
    		}
    		// decelerate
    		for (int i = 100; i >= 0; i--) {
...
//    	        System.out.println("--> should drive forward: " + i);
        ...
        for (int j = 0; j < 3; j++) {
    		...
    		for (int i = 0; i <= 100; i++) {
    			pi2go.go(-i);
//    	        System.out.println("--> should drive backward: " + i);
    			Thread.sleep(5);
    		}
    		// decelerate
    		for (int i = 100; i >= 0; i--) {
