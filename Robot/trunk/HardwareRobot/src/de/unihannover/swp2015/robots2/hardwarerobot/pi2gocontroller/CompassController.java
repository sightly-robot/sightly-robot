 ...
 */
public class CompassController implements MultiAxisGyro {

	private static CompassController instance;
	 ...
	 * Therefore it initializes the compass module.
	 * 
	 * @throws IOException
	 *             thrown if the compass module could not be found
	 */
	private CompassController() throws IOException {
	...
	/**
	 * Gets the instance of the CompassController.<br>
	 * If the instance is {@code null} a new one will be created.
	 * 
	 * @return the CompassController instance
	 */
	...
	/**
	 * Sets the output rate to the specified value.
	 * 
	 * @param outputRate
	 *            the new output rate
	 */
	...
	/**
	 * Gets the samples average.
	 * 
	 * @return the samples average
	 */
	...
	/**
	 * Sets the samples average to the specified value.
	 * 
	 * @param samplesAverage
	 *            the new samples average
	 */
	...
	/**
	 * Gets the current measurement mode as integer.
	 * 
	...
	/**
	 * Sets the measurement mode to the specified value.
	 * 
	...
	/**
	 * Gets the gain value as integer.
	 * 
	 * @return the gain
	 */
	public int getGain() {
	...
	/**
	 * Initializes the specified {@link Gyroscope} with the specified triggering
	 * mode.
	 * 
	 * @param triggeringAxis
	 *            the {@code Gyroscope} to initialize
	 * @param triggeringMode
	 *            the triggering mode for the {@code Gyroscope}
	 * @throws IOException
	 *             thrown if the {@code Gyroscope} is not available
	 */
	...
	public static void main(String[] args) throws Exception {
		CompassController hmc5883l = CompassController.getInstance();
	...
	/**
	 * Creates a string representation of the compass module.
	 * 
	 * @param i
	 *            value to convert to string
	 * @param l
	 *            number of maximal leading spaces
