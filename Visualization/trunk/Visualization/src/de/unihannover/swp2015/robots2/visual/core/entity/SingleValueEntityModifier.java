...
/**
 * Implements an EntityModifier. It should be used when you want to modify exactly one value (stepwise of course).
 * 
 * @author Rico Schrage
 */
public abstract class SingleValueEntityModifier extends EntityModifier {
     ...
     */
    public SingleValueEntityModifier(final IEntity target, final float duration, final float fromValue, final float toValue) {
     ...
     */
    public SingleValueEntityModifier(final IEntity target, final float duration, final float fromValue, final float toValue, final IEaseFunction easeFunction) {
     ...
     * 
     * @param value currentValue calculated with the {@link IEaseFunction}
     * @param entity target
     */
