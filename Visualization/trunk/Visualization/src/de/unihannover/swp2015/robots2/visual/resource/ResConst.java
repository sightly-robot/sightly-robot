...
public enum ResConst {
	...
	DEFAULT_WALL("default_wall", ResType.TEX), DEFAULT_ONEWAY("default_oneway", ResType.TEX,
			TextureFilter.Linear), DEFAULT_FIELD("default_field", ResType.TEX), DEFAULT_FIELD_1("default_field_one",
					ResType.TEX), DEFAULT_FIELD_2("default_field_two", ResType.TEX), DEFAULT_FIELD_2_CURVE(
							"default_field_2_c", ResType.TEX), DEFAULT_FIELD_3("default_field_three",
									ResType.TEX), DEFAULT_FIELD_4("default_field_four", ResType.TEX), DEFAULT_RES_1(
											"default_res_one",
											ResType.TEX), DEFAULT_RES_2("default_res_two", ResType.TEX), DEFAULT_RES_3(
													"default_res_three", ResType.TEX), DEFAULT_RES_4("default_res_four",
															ResType.TEX), DEFAULT_RES_5("default_res_five",
																	ResType.TEX), DEFAULT_RES_6("default_res_six",
																			ResType.TEX), DEFAULT_RES_7(
																					"default_res_seven",
																					ResType.TEX), DEFAULT_RES_8(
																							"default_res_eight",
																							ResType.TEX), DEFAULT_RES_9(
																									"default_res_nine",
																									ResType.TEX), DEFAULT_RES_10(
																											"default_res_ten",
																											ResType.TEX), DEFAULT_ROBO(
																													"default_robo",
																													ResType.TEX), DEFAULT_BUBBLE(
																															"default_bubble",
																															ResType.TEX), DEFAULT_STARTPOS(
																																	"default_startpos",
																																	ResType.TEX,
																																	TextureFilter.Linear), DEFAULT_WARNING(
																																			"default_warning",
																																			ResType.TEX), DEFAULT_CONNECTION(
																																					"default_connection",
																																					ResType.TEX), DEFAULT_RECT(
																																							"default-rect",
																																							ResType.TEX,
	...
	SKIN_TITLE_FONT("title-font", ResType.SKIN), SKIN_DEFAULT_FONT("default-font",
			ResType.SKIN), SKIN_RANKING_FONT("ranking-font", ResType.SKIN);
