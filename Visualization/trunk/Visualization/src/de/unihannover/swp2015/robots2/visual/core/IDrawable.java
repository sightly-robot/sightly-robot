 ...
 * <code>drawable</code>. This means you can call {@link #draw(Batch)} to
 * visualize the internal state of these objects. <br>
 * The difference to {@link IRenderable} is, that drawable classes don't have to
 * manage their batches theirself. <br>
 * Note: Normally, a drawable object will be child of a renderable object. Also
 * you don't have to call {@link Batch#begin()} {@link Batch#end()} yourself.
 * 
 * @author Rico Schrage
 */
